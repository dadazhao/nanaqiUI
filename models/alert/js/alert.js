nnq(function(nnq) {
    ...
    function initalizeElement(nnq) {
        ...
        alert_ele.push(id);
        alert_ele.push('" class="message alert__message ');
        ...
        alert_ele.push('px;"');
        alert_ele.push(' >');
        alert_ele.push('<i class="icon ')
        alert_ele.push(nnq.alert.defaults.icon);
        alert_ele.push('"></i>');
        alert_ele.push('<span class="lable">');
    ...
    function removeElement() {
        ...
        for (var i = 0; i < alertList.length; i++) {
            ...
            if (alertList[i].datetime < date - nnq.alert.defaults.lifeDate) {
                ...
                nnq(".alert__message").each(function() {
    ...
    nnq.alert = function(options) {
        if (typeof options == 'string') {
            ...
            nnq.alert.defaults.icon = "icon-warnning";
        } else {
